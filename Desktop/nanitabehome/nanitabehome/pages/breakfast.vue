<script setup>
const[rankingData, dataBreakfast] = await Promise.all([
...
const recipeBreakafast = dataBreakfast.data.value.meals;

recipeBreakafast.forEach((e) => {
...
<Main>
	<article class="box media">
		<Catpage :recipeList="recipeBreakafast">
			<h2>朝食カテゴリーレシピ一覧</h2>
		</Catpage>
	</article>
